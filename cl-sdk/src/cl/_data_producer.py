...
class StimCommand:
    ...
    current_uA   : float = field(default=1.0, compare=False)
...
class DataProducer(BaseProducer):
    ...
    def queue_stim(
        ...
        Args:
            ...
            current_uA: Stimulation current. Replay mode records the stim event
                only; the biological twin backend uses this for MEA coupling.
        """
