...
Status reflects the 2026-06-06 task-assay work


| Directory                                          | Date       | Status                 | What it is                                                                                                                                                         |
| -------------------------------------------------- | ---------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `manifold_analysis_20260613T224052Z` | 2026-06-13 | **Citable (latest)** | Memory-geometry probes: weight-interpolation breaking point and surgical ablations against the validated readout |
| `snn_reset_relearning_exhaustive_20260606T070543Z` | 2026-06-06 | **Citable**   | Validated 60-protocol grid with the relearning/savings round on the two learned tasks                                                                              |
